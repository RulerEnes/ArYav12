exports.run = (client, message) => {
    ...
    if (küfür) {
        ...
        message.channel.send(`**Başarılı bir şekilde küfür engel kapandı.**`).then(l => {
            l.delete({
                timeout: 5000
            })
        })
        ...
        message.channel.send(`**Başarılı bir şekilde küfür engel açıldı.**`).then(l => {
            l.delete({
                timeout: 5000
            })
        })
...
exports.help = {
    name: 'küfürengel',
    description: 'küfrü engel açar kapar'
}