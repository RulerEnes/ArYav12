...
exports.run = (client, message, params) => {
  ...
  if (message.channel.type !== 'dm') {
    ...
    .setDescription('Özel mesajlarını kontrol et (Hatırlatma==>cihazını yatay şekilde tutmanızı öneririz). :postbox:');
...
exports.help = {
  name: 'yardım',
  description: 'Tüm komutları DM yoluyla size iletir.',
  usage: 'yardım [komut]'
};