...
//GENEL KOMUTU
  ...
  .setFooter('© ArYa Software')
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Dave Et](https://discord.com/oauth2/authorize?client_id=834763013248122910&scope=bot&permissions=4228906239)` + "** | **" + `[Destek Sunucusu](https://discord.gg/ggvVXvMn2Z)` + "** | **" + `[Top.gg Oy](https://top.gg/bot/834763013248122910)`, false)
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Sunucu').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=834763013248122910&scope=bot&permissions=4228906239)` + "** | **" + `[Destek Sunucusu](https://discord.gg/SNCWVbxpax )` + "** | ** +" `[Top.gg Oy](https://top.gg/bot/834763013248122910)`, false)
...
//YARDIM KOMUTU
  ...
  exports.conf = {
    aliases: ['help', 'h', 'komutlar','y'], //Komutun farklı yazılışlarla kullanımları
